...
Toolkit.run(async ( tools ) => {
  ...
  resource.repository.projects.nodes.forEach( node => tools.log( node.number, projectNumber, typeof node.number, typeof projectNumber ) );
